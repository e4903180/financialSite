...
class GmailOtherHandle():
    ...
    def _verify_gmail_api(self) -> None:
...
if __name__ == "__main__":
    ...
    gmail_other_handle = GmailOtherHandle()

    try:
        gmail_other_handle.run()
    except Exception as e:
        log_notify_service.send_email("Gmail其他研究報告更新狀態", str(e))