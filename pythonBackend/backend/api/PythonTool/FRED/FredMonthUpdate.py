...
class FredUpdate():
    ...
    def _update_PPI(self) -> None:
        ...
        new_data = round(100 * ((self.PPI_data[-1] - self.PPI_data[-1 - 12]) / self.PPI_data[-1 - 12]), 2)
    ...
    def _update_PCE(self) -> None:
        ...
        new_data = round(100 * ((self.PCE_data[-1] - self.PCE_data[-1 - 12]) / self.PCE_data[-1 - 12]), 2)
    ...
    def _update_RPCEG(self) -> None:
        ...
        new_data = round(100 * ((self.RPCEG_data[-1] - self.RPCEG_data[-1 - 12]) / self.RPCEG_data[-1 - 12]), 2)
