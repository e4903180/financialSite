 ...
 * @category Filtering
 */
export declare const gridFilterStateSelector: (state: GridStateCommunity) => import("@mui/x-data-grid/hooks/features/filter/gridFilterState").GridFilterState;
/**
 ...
 */
export declare const gridVisibleRowsLookupSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, Record<import("@mui/x-data-grid").GridRowId, boolean>>;
/**
 * @category Filtering
 * @ignore - do not document.
 */
 ...
 * @category Filtering
 */
export declare const gridVisibleSortedRowEntriesSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, {
 ...
 * @category Filtering
 */
export declare const gridVisibleSortedRowIdsSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, import("@mui/x-data-grid").GridRowId[]>;
/**
 * Get the id and the model of the rows accessible after the filtering process.
 ...
 */
export declare const gridVisibleRowsSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, import("@mui/x-data-grid").GridRowId[]>;
/**
 * Get the id and the model of the top level rows accessible after the filtering process.
 * @category Filtering
 */
export declare const gridVisibleSortedTopLevelRowEntriesSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, {
    id: import("@mui/x-data-grid").GridRowId;
    model: any;
}[]>;
/**
 ...
 * @category Filtering
 */
export declare const gridVisibleRowCountSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, number>;
/**
 * Get the amount of top level rows accessible after the filtering process.
 * @category Filtering
 */
export declare const gridVisibleTopLevelRowCountSelector: import("@mui/x-data-grid/utils/createSelector").OutputSelector<GridStateCommunity, number>;
/**
 * @category Filtering
 * @ignore - do not document.
 */
