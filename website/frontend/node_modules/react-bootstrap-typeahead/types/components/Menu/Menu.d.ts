...
declare const Menu: {
    ...
    propTypes: {
        ...
        id: (props: import("react-bootstrap-typeahead/types/types").TypeaheadProps, propName: keyof import("react-bootstrap-typeahead/types/types").TypeaheadProps, componentName: string) => void;
