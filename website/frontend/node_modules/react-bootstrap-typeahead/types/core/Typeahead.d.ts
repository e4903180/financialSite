...
import { noop } from 'react-bootstrap-typeahead/types/utils';
import type { Option, RefElement, SelectEvent, TypeaheadProps, TypeaheadState } from 'react-bootstrap-typeahead/types/types';
...
declare class Typeahead extends React.Component<Props, TypeaheadState> {
    ...
    clear: () => void;
    focus: () => void;
    getInput: () => RefElement<HTMLInputElement>;
    inputRef: (inputNode: RefElement<HTMLInputElement>) => void;
